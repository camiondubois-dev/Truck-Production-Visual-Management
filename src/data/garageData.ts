...
export const GARAGE_TO_SLOTS: Record<string, string[]> = {
  ...
  'sous-traitants':      ['S-01', 'S-02', 'S-03', 'S-04', 'S-05', 'S-06', 'S-07', 'S-08', 'S-09', 'S-10', 'S-11', 'S-12'],
...
export const STATIONS: {
  ...
  },
  {
    ...
    gridCols: 4,
    slots: [
      { id: 'S-01' }, { id: 'S-02' }, { id: 'S-03' }, { id: 'S-04' },
      { id: 'S-05' }, { id: 'S-06' }, { id: 'S-07' }, { id: 'S-08' },
      { id: 'S-09' }, { id: 'S-10' }, { id: 'S-11' }, { id: 'S-12' },
    ],
  },
  {
